          ...
          {!isLoading && (
            <div className="mt-6">
              <div className="flex  items-center">
                ...
                <p className="text-[#bec1c2] mt-2 ml-2 ">
                  Verify your email: We've sent an email to your inbox.
                </p>
              </div>
              ...
              <div className="flex  items-center my-4">
                ...
                <p className="text-[#bec1c2] mt-2 ml-2 ">
                  {" "}
                  <a
                    href="https://t.me/+0d8skT2bV1YxNTU1"
                    className=" font-extrabold text-success-500"
                    target="_blank"
                    onClick={() => {
                  ...
                  to join our private telegram channel.
                </p>
              </div>
              ...
              <div className="flex  items-center">
                ...
                <p className="text-[#bec1c2] mt-2 ml-2 ">
                  {" "}
                  Start trying our app by clicking the button below.
                </p>
              </div>
            </div>
          )}
