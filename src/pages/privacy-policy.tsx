  ...
  return (
    <HomeLayout>
      <div className="p-16 max-lg:px-5">
        ...
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">1. Information We Collect</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">3. How We Use Your Information</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">5. Sharing Your Information</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">9. Data Security</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">11. Children’s Privacy</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">13. Your Choices</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">15. Changes to this Policy</p>
        <p className="font-workSansThin mt-2">
        ...
        <p className="font-workSansThin mt-2">17. Contact Us</p>
        <p className="font-workSansThin mt-2">
